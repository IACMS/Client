                ...
                <thead>
                  <tr className="bg-slate-50 border-b border-outline-variant text-label-caps text-slate-500 text-xs">
                    <th className="p-4 font-semibold">
                      {t("referrals.table.case")}
                    </th>
                    <th className="p-4 font-semibold">
                      {t("referrals.table.direction")}
                    </th>
                    ...
                    return (
                      <tr key={r.id} className="hover:bg-slate-50/50 align-top">
                        <td className="p-4 text-sm">
                          ...
                          {r.case?.title && (
                            <p className="text-slate-800 font-medium mt-0.5 truncate max-w-xs">
                              {r.case.title}
                            </p>
                          )}
                          {r.referralReason && (
                          ...
                          {dir === "outgoing" && r.progress ? (
                            <div className="space-y-1 min-w-[180px]">
                              ...
                              <p className="text-xs text-slate-500">
                                Last updated:{" "}
                                {formatWhen(r.progress.lastUpdatedAt)}
                              </p>
                            </div>
                          ) : (
